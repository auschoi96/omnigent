...
class _StubClient:
    ...
    :param fork_result: The typed-equivalent object returned by ``sessions.fork()``.
    ...
    def __init__(
        self,
        fork_result: SimpleNamespace | None = None,
...
class _StubSessionsNamespace:
    ...
    :param fork_result: Typed-equivalent object to return from ``fork()``.
...
async def test_fork_legacy_mode_renders_error() -> None:
    ...
    """
    client = _StubClient(fork_result=SimpleNamespace(id="should_not_reach"))
    host = _CapturingHost()
