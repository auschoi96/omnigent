...
from omnigent.server import schemas as _server_events
...
def _wire_type(cls: type) -> str:
    ...
    :param cls: A subclass of the server schema's ``_SSEEventBase``,
...
_T_RESPONSE_CREATED = _wire_type(_server_events.CreatedEvent)
_T_RESPONSE_QUEUED = _wire_type(_server_events.QueuedEvent)
_T_RESPONSE_IN_PROGRESS = _wire_type(_server_events.InProgressEvent)
_T_RESPONSE_COMPLETED = _wire_type(_server_events.CompletedEvent)
_T_RESPONSE_FAILED = _wire_type(_server_events.FailedEvent)
_T_RESPONSE_INCOMPLETE = _wire_type(_server_events.IncompleteEvent)
_T_RESPONSE_CANCELLED = _wire_type(_server_events.CancelledEvent)
_T_RESPONSE_OUTPUT_TEXT_DELTA = _wire_type(_server_events.OutputTextDeltaEvent)
_T_RESPONSE_REASONING_STARTED = _wire_type(_server_events.ReasoningStartedEvent)
_T_RESPONSE_REASONING_TEXT_DELTA = _wire_type(_server_events.ReasoningTextDeltaEvent)
_T_RESPONSE_REASONING_SUMMARY_TEXT_DELTA = _wire_type(
    _server_events.ReasoningSummaryTextDeltaEvent
)
_T_RESPONSE_OUTPUT_ITEM_DONE = _wire_type(_server_events.OutputItemDoneEvent)
_T_RESPONSE_OUTPUT_FILE_DONE = _wire_type(_server_events.OutputFileDoneEvent)
_T_RESPONSE_RETRY = _wire_type(_server_events.RetryEvent)
_T_RESPONSE_ERROR = _wire_type(_server_events.ErrorEvent)
_T_RESPONSE_COMPACTION_IN_PROGRESS = _wire_type(_server_events.CompactionInProgressEvent)
_T_RESPONSE_COMPACTION_COMPLETED = _wire_type(_server_events.CompactionCompletedEvent)
_T_RESPONSE_COMPACTION_FAILED = _wire_type(_server_events.CompactionFailedEvent)
_T_RESPONSE_CLIENT_TASK_CANCEL = _wire_type(_server_events.ClientTaskCancelEvent)
_T_RESPONSE_ELICITATION_REQUEST = _wire_type(_server_events.ElicitationRequestEvent)
